...
export function buildWebsiteHtml(draft: BuilderDraftV2, options: { preview?: boolean } = {}): string {
...
<body>
  ...
  <header class="site-header">
    ...
    <nav aria-label="Hauptnavigation"><a href="#leistungen">Leistungen</a><a href="#zeiten">Öffnungszeiten</a>${testimonials.length ? '<a href="#stimmen">Stimmen</a>' : ""}</nav>
