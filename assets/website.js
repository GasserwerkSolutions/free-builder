...
function targetAttrs(options, target, occurrence, interactive = false) {
    if (!options.preview)
        return "";
...
function regionAttr(options, region) {
    return options.preview ? ` data-preview-region="${region}"` : "";
}
function panelAttr(options, panel) {
    return options.preview ? ` data-preview-panel="${panel}"` : "";
}
function sectionAttrs(options, section, panel) {
...
function editable(value, target, occurrence, options) {
    if (!options.preview)
